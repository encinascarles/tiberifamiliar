...
export default function AuthLayout({
  ...
  return (
    <div className="w-screen sm:container h-screen flex items-center justify-center">
      <Card className="relative flex h-full sm:h-auto w-full border-0 sm:border shadow-none sm:shadow-sm items-center">
        ...
        <div className="lg:relative h-[80vh] w-full lg:w-6/12 flex justify-center items-center p-8">
          <Link href="/">
